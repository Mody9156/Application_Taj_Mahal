    ...
    var body: some View {
        HStack {
            ...
            VStack(alignment: .leading) {
                ...
                Text(apetizer.description).font(.caption2)
                    .fontWeight(.medium)
                ...
                HStack{
                    Text("\(apetizer.price,format:.number.precision(.fractionLength(2)))€")
