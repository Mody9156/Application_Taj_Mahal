    ...
    var body: some View {
        NavigationStack {
            VStack(alignment: .leading){
                Image("TajMahal")
                    .resizable()
                    .frame(width: 335,height: 423)//picture for the view
                ...
                HStack(spacing: 170){
                    VStack (alignment: .leading) {
                        ...
                        Text("Taj Mahal")
                            .font(.custom("PlusJakartaSans-wgt.ttf",size:18))
                ...
                VStack (alignment: .leading){
                    ForEach(ArrayBottomView,id:\.self){ Array in
                        BottomView(name: Array.name, img: Array.img, moreNews: Array.moreNews)
                            .padding(5)// éléments de la struct BottomView  ⇣
                    }
                }
                ...
                NavigationLink {
                    ...
                    ZStack {
                        Rectangle()
                            .frame(width: 335,height: 40).cornerRadius(10)
                            .foregroundColor(Color(red: 207/255, green: 47/255, blue: 47/255, opacity: 1.0))
...
struct BottomView: View ,Hashable{
    ...
    var body: some View {
        HStack(spacing : Spacing(for:name)){ // utilisation de la  function Spacing ⇣
            Label(name, image: img)
                .font(.custom("PlusJakartaSans-600.ttf", size: 12))
                .foregroundColor(Color(red: 154/255, green: 154/255, blue: 154/255, opacity: 1.0))
                Text(moreNews)
                .font(.custom("PlusJakartaSans-600.ttf", size: 12))
                .foregroundColor(Color(red: 154/255, green: 154/255, blue: 154/255, opacity: 1.0))
